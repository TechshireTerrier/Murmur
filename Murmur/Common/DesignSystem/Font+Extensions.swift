...
extension Font {
    ...
    static let PretendardTitle1SemiBold = Font.custom("Pretendard-SemiBold", size: 28, relativeTo: .body)
    ...
    static let PretendardTitle3SemiBold = Font.custom("Pretendard-SemiBold", size: 20, relativeTo: .title3)
    ...
    static let PretendardBodySemiBold = Font.custom("Pretendard-SemiBold", size: 17, relativeTo: .body)
